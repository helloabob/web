...
var ddd_arr=new Array(216,210,212,217,220,211,215,214,218,501,219);
var ddd_url_arr=new Array('/live/2009-05-17/310.shtml','/live/2009-05-17/305.shtml','/live/2009-05-17/308.shtml','/live/2009-05-17/311.shtml','/live/2009-05-17/314.shtml','/live/2009-05-17/307.shtml', '/live/2009-05-17/306.shtml', '/live/2009-05-17/309.shtml', '/live/2009-05-17/312.shtml','/live/2009-05-17/529.shtml', '/live/2009-05-17/313.shtml');
...
function WriteIndexPlayer(mydiv,myid,mytp,myendtp,linkurl)
{
    if (!getObject("smgbbFlashID01")) {
        var smgbbFlash2 = new smgFlash("/bbtv_common/index_flash/video_com.swf", "smgbbFlashID01", "255", "190", "7", "#ffffff");
...
window.setTimeout("Getairdom_settime();",60000); 
	...
	$("div#float_r").draggable();
        ...
        $("div.tabCon span.blue").each(function(i){
                $(this).html("<a href='"+ddd_url_arr[i]+"'>"+$(this).text()+"</a>");
        });
});
